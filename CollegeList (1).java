...
public class CollegeList {
    public static void main(String[] args) {
        ...
        while (choice != 'E' && choice != 'F' && choice != 'S') {
            ...
            choice = runan.next().charAt(0);
        }

        System.out.println("Enter Name:");
        runan.nextLine();  
        String name = runan.nextLine();
        System.out.println("Enter Contact Number:");
        String contactNum = runan.nextLine();
        ...
        if (choice == 'E') {
            ...
            double salary = runan.nextDouble();
            System.out.println("Enter Department:");
            runan.nextLine();  
            String department = runan.nextLine();
            ...
            char regular = runan.next().charAt(0);
            ...
            String program = runan.nextLine();
            student.setProgram(program);
            
            System.out.println("Enter Year Level (1-4):");
            int yearLevel = runan.nextInt();
